...
My true friend."""
    ...
    poem_y4 = Poem(
    author = "yuri",
    title = "Yuri's Happy Thoughts (version 2)",
    text = """\
Yuri’s here, and I'm singing what I wanted to feel.
Turning angles into endless pits;
Gearboxes falling from these holy stakes;
Endless portals to another worlds;
Strange heroes fighting against me;
My friends are tied to these thickened ropes;
I'm controlled by the Ruby’s wrath…
Like a Marionette...
...
I wanted to embrace all of these
        HAPPY THOUGHTS HAPPY THOUGHTS
        HAPPY HAPPY HAPPY THOUGHTS

Third Eye is tempting me with these
        HAPPY THOUGHTS HAPPY THOUGHTS
        HAPPY HAPPY HAPPY THOUGHTS

Get inside my head and give me
        HAPPY THOUGHTS HAPPY THOUGHTS
        HAPPY HAPPY HAPPY THOUGHTS

Forty gears, spinning wheels and a ticking clock;
Bloody prayers written in these harness torns;
The Dark Cloud drinks my breathing blood;
Have you ever heard of a warmer ghost?
Monika failed to reprogram the script;
My mind is giving up to the glitched code;
Touching my whole body with your stolen pen!
Have you considered killing yourself???

The flickering light no longer shines!!!
Raccoon is hungry for my slice of blood!!!
The breeze is not gentle and the sand is dry!!!
Drive the knife into my flesh, make me a mess!!!
Breathing human eyes, skies and gods!!!
Diabolist sticks, curial pentagraphs!!!
...
THE RACCOON
    ...
    FOR YOUR SOUL
PAY THE PRICE...
            FOLLOW THE YURISM CULT!

Your minds will soon obey to my
        HAPPY THOUGHTS HAPPY THOUGHTS
        HAPPY HAPPY HAPPY THOUGHTS

You will be forced to embrace all my
        HAPPY THOUGHTS HAPPY THOUGHTS
        HAPPY HAPPY HAPPY THOUGHTS

LISTEN TO YOUR THIRD EYE AND DREAM WITH
        HAPPY THOUGHTS HAPPY THOUGHTS
        HAPPY HAPPY HAPPY THOUGHTS

KNIVES ARE STABING ME, I WANT THESE
        HAPPY THOUGHTS HAPPY THOUGHTS!!
        HAPPY HAPPY HAPPY THOUGHTS!!
...
What end
Could end
With an ending like you?

    as you laugh, or cry
        as we breathe and die
            do we ever want to say goodbye?

Velvet has a mysterious touch.
Your hair velvetier than much.
But do you recall,
...
What have you said?
You ask ahead.
But you hear naught but silence.
Will you steed your courage
And cut through the forage
Of my doubt into my heart?
There, everything should be uncluttered now..."""
    )
    ...
    title = "My True Crush",
    text = """\
In the ways you move
I groove, I groove.
In the ways you say
I obey, I obey.
In the ways you leave me
...
You cannot see me.
I convey, I convey.
In the ways you love me
I lose, I lose.
In the ways you win me."""
    )
    ...
    text = """\
The cold.
Unforgiving wastes of the mind.
But you can put on a parka?
Nay, they say.
Cull the chillling cold.

The heat.
They make the cheeks hot.
But you can open a window?
Nay, I say.
The cold is comfort
and nary a comfort I need.

Feeling.
A chilling simmer of the soul.
   but you can be stepped upon?
   but you cannot be loved?
   but they do not want you?
Yea, we say.
I am forsaken.

But your light? Aye, I sigh.
   your light would drown me
   your kindness would kill me
   your care would cripple me
Aye, I sigh. No light for me..."""
    )

    poem_n5 = Poem(
    author = "natsuki",
    title = "Pumped Up Natsukis",
    text = """\
All the oth-th-ther kids with the pumped up kicks
...
Natsu's got a quick hand
She'll look around the room, she won't tell you her plan
She's got a rolled protein bar,
hanging out her mouth she's a cowboy kid
Yeah found a six shooter gun
In his Papa's closet hidden oh in a box of manga things
...
Papa works a long day
He be coming home late, he's coming home late
And he's bringing me a surprise
There's no dinner in the kitchen, punches packed in ice
I've waited for a long time
Yeah the slight of my hand is now a quick pull trigger
I reason with my protein bar
And say your hair's on fire, you must have lost your wits, yeah...

(your wits, yeah...your wits, yeah...your wits, yeah...your wits, yeah...)
(your wits, yeah...your wits, yeah...your wits, yeah...your wits, yeah...)
Faster than my bullet!
...
Faster than my bullet!"""
    ...
    poem_m5 = Poem(
    author = "monika",
    title = "All Hail Monika! (Shadow's Poem)",
    text = """\
ALL HAIL MONIKA!
POETS RISE AGAIN!
Hyper deleting
Everyone that loves her man
Nothing can stop her now
No glitch to bring her down
When there's not a route for her
She wins!
...
Suffer long and she will set you free
Only through poems find all the romance you need!
It's never over, just another delete!
All hopes, love and tears, and everyone that comes her way!

Determination of the strong.
Found the person that she loves for so long!
...
This deletion is the
Only poem she writes
Everyday she imagined
A future where she can be with you
She will forever fill this
...
Arising I go
Into the park
Regarding the calmness of me.\n\n

Thanks for visiting the Literature Club!"""
    )

    poem_s6 = Poem(
    author = "sayori",
    title = "Original Title Zone Act 1",
    text = """\
Get out of my head. Get out of my head. Get out of my head. Get out of my head.
Get out of my head. Get out of my head. Get out of my head. Get out of my head.\n

You know what? I'm too lazy for do this shit again, so take this\n

for i in range(9999999):
    print("Get out of my head, repeat i.", end="Get. Out. Of. My. Head. Please!")

Ha ha ha! And everyone believed that Sayori was airhead and stupid!
\n\n\n
Get out of my head before SONIC.EXE COMES FOR YOU.
Get out of my head before MONIKA GASLIGHTS MY THOUGTHS.
Get out of my head BECAUSE YOU WERE SO DENSE TO NOT NOTICE ME!
Get out of my head before I PUT THIS NOOSE ON MY NECK.\n\n\n\n\n\n\n
But we never finish the poems of our lives.
We just stop breathing.

\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n

Congratulations, you reached the end of the poem!
If you were too bored to reach this part
Visit https://discord.gg/Br7CHAw
And comment: I reached the end of the poem!
Thank you!"""
    )
...
label showpoem(poem=None, music=True, track=None, revert_music=True, img=None, where=i11, paper=None):
    ...
    if music and revert_music:
        ...
        $ audio.t5c = "<from " + str(currentpos) + " loop 3.172>bgm/9.ogg"
