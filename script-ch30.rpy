...
label ch30_noskip:
    ...
    if persistent.current_monikatopic != 0:
        m "Now, where was I...?"
        pause 4.0
        call expression "ch30_" + str(persistent.current_monikatopic) from _call_expression_22
    jump ch30_loop
    return
...
label ch30_endb:
    ...
    $ consolehistory = []
    call updateconsole("renpy.file(\"characters/monika.chr\")", "monika.chr does not exist.") from _call_updateconsole_22
    m "HELP ME!!!"
    show m_rectstatic
    show m_rectstatic2
    show m_rectstatic3
    ...
    pause 3.0
    call updateconsole("renpy.file(\"characters/monika.chr\")", "monika.chr does not exist.") from _call_updateconsole_23
    call updateconsole("renpy.file(\"characters/monika.chr\")", "monika.chr does not exist.") from _call_updateconsole_24
...
label ch30_autoload:
    ...
    if persistent.monika_reload <= 4:
        call expression "ch30_reload_" + str(persistent.monika_reload) from _call_expression_23
    else:
    ...
    if persistent.current_monikatopic != 0:
        m "Now, where was I...?"
        pause 4.0
        call expression "ch30_" + str(persistent.current_monikatopic) from _call_expression_24
    jump ch30_loop
...
label ch30_loop:
    ...
    call expression "ch30_" + str(persistent.current_monikatopic) from _call_expression_25
    jump ch30_loop
