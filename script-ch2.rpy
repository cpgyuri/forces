...
label ch2_main:
    ...
    call expression nextscene from _call_expression_27
    ...
    menu:
        ...
        "I would walk home with [ch2_winner].":
            if ch2_winner == "Natsuki":
                call ch2_end_natsuki from _call_ch2_end_natsuki_2
            else:
                call ch2_end_yuri from _call_ch2_end_yuri_2
        "I would still walk home with Sayori.":
            call ch2_end_sayori from _call_ch2_end_sayori_2
