...
init -1000 python:
    rsod_messages = {
                     ...
                     "yuri_lock": "PERSISTENT_YURI_KNIFE_VIOLATION",
                     "sayori_lock": "SAYORI_SOUL_INTEGRITY_VIOLATION"
                    }
    rsod_search_text = "If you'd like to know more, go to https://discord.gg/gDDdg8d and ask for this error: "
...
image rsod_yuriknife_test_lock_message = Text(rsod_messages["yuri_lock"], font="Resources/systemfont/Medium.ttf", size=24, color="#ffffff", style="_default")
image rsod_sayori_test_lock_message = Text(rsod_messages["sayori_lock"], font="Resources/systemfont/Medium.ttf", size=24, color="#ffffff", style="_default")
