...
init python:
    class RenpyApp(Applet):
        ...
        def edm_session_revamped(self, songname):
            self.send_temporary_notification("DJ Sona", "You are listening to " + songname +".", action=Return(1))
