...
image forces_message = Text("Join the Resistance", font="Resources/systemfont/Light.ttf", size=14, style="_default")
...
image ddf_boot_mascot:
    "Resources/ghostori_alicelogo.png"
    xoffset aliceOffset xzoom aliceZoom
    block:
        function randomPauseAlice
        parallel:
